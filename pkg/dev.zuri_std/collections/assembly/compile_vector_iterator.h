...
#ifndef ZURI_STD_COLLECTIONS_COMPILE_VECTOR_ITERATOR_H
#define ZURI_STD_COLLECTIONS_COMPILE_VECTOR_ITERATOR_H
...
#endif // ZURI_STD_COLLECTIONS_COMPILE_VECTOR_ITERATOR_H
