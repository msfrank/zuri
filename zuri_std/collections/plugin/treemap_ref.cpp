...
//static bool
//quick_compare(const DataCell& lhs, const DataCell& rhs)
//{
//    TU_ASSERT (lhs.type == rhs.type);
//    switch (lhs.type) {
//
//        // singleton types always compare false
...
//        case DataCellType::UTF16:
//            return u_strncmp(lhs.data.utf16.data,
//                             rhs.data.utf16.data,
//                             lhs.data.utf16.size < rhs.data.utf16.size?
//                                 lhs.data.utf16.size : rhs.data.utf16.size) < 0;
//
//        // compare UTF-8 strings
//        case DataCellType::UTF8:
//            return std::strncmp(lhs.data.utf8.data,
//                                rhs.data.utf8.data,
//                                lhs.data.utf8.size < rhs.data.utf8.size?
//                                    lhs.data.utf8.size : rhs.data.utf8.size) < 0;
//
