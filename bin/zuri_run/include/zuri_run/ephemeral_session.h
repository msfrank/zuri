...
#ifndef ZURI_RUN_EPHEMERAL_SESSION_H
#define ZURI_RUN_EPHEMERAL_SESSION_H
...
namespace zuri_run {
    ...
    public:
        ...
        tempo_utils::Result<lyric_runtime::Operand> executeFragment(
...
#endif // ZURI_RUN_EPHEMERAL_SESSION_H