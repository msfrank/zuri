#ifndef ZURI_BUILD_PROVIDE_OBJECT_TASK_H
#define ZURI_BUILD_PROVIDE_OBJECT_TASK_H
...
namespace zuri_build {
    ...
    class ProvideObjectTask : public lyric_build::BaseTask, ProviderTaskOperations {
    ...
    lyric_build::BaseTask *new_provide_object_task(
        const lyric_build::BuildGeneration &generation,
        const lyric_build::TaskKey &key,
        std::weak_ptr<lyric_build::BuildState> buildState,
        std::shared_ptr<tempo_tracing::TraceSpan> span);
...
#endif // ZURI_BUILD_PROVIDE_OBJECT_TASK_H
