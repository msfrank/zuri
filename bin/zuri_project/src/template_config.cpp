...
class ParameterEntryParser : public tempo_config::AbstractConverter<zuri_project::ParameterEntry> {
public:
    tempo_utils::Status convertValue(
        const tempo_config::ConfigNode &node,
        zuri_project::ParameterEntry &value) const override
    {
        ...
        TU_RETURN_IF_NOT_OK (tempo_config::parse_config(value.type, typeParser, parameterConfig, "type"));
